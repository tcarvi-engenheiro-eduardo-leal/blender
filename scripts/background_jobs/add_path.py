...
def _update_path_to_unix(windows_path):
    windows_path = windows_path.replace('C:\\libs\\python\\src\\', '/Users/eduardosantosleal/src/')
...
def _dir_src_add():
    t_dir_src_add = \
        'C:\\libs\\python\\src\\github.com\\tcarvi\\tgraphics\\scripts\\add'
...
def _dir_src_evaluate():
    t_dir_src_evaluate = \
        "C:\\libs\\python\\src\\github.com\\tcarvi\\tgraphics\\scripts\\evaluate"
    if sys.platform.startswith('linux') or sys.platform.startswith('darwin'):
...
def _dir_src_geometry():
    t_dir_src_geometry = \
        "C:\\libs\\python\\src\\github.com\\tcarvi\\tgraphics\\scripts\\geometry"
    if sys.platform.startswith('linux') or sys.platform.startswith('darwin'):
...
def _dir_src_io():
    t_dir_src_io = \
        'C:\\libs\\python\\src\\github.com\\tcarvi\\tgraphics\\scripts\\io'
    if sys.platform.startswith('linux') or sys.platform.startswith('darwin'):
...
def _dir_src_list():
    t_dir_src_list = \
        "C:\\libs\\python\\src\\github.com\\tcarvi\\tgraphics\\scripts\\list"
    if sys.platform.startswith('linux') or sys.platform.startswith('darwin'):
...
def _dir_src_model():
    t_dir_src_model = \
        "C:\\libs\\python\\src\\github.com\\tcarvi\\tgraphics\\scripts\\model"
    if sys.platform.startswith('linux') or sys.platform.startswith('darwin'):
...
def _dir_src_move():
    t_dir_src_move = \
        "C:\\libs\\python\\src\\github.com\\tcarvi\\tgraphics\\scripts\\move"
    if sys.platform.startswith('linux') or sys.platform.startswith('darwin'):
...
def _dir_src_input_data():
    t_dir_src_input_data = \
        "C:\\libs\\python\\src\\github.com\\tcarvi\\tgraphics\\input_data"
    if sys.platform.startswith('linux') or sys.platform.startswith('darwin'):
